...
namespace QL_BHX
{
    ...
    {
        Form frmDangNhap, frmNhanVien, frmHoaDon, frmQLSP;
        /// <summary>
        ...
        private void tsmManager_Product_Click(object sender, EventArgs e)
        {
            frmQLSP = new frmQuanLy_SP();
            frmQLSP.MdiParent = this;
            Ultilities.checkForm(frmQLSP);
        }
